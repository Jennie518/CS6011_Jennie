...
public class AudioComponentWidgetBase extends Pane implements BaseWidgetAndSpeaker {
    // fields
    protected AudioComponentWidgetBase inputWidget_;
...
//    AudioComponentWidgetBase() {}
    ...
    public void endConnection(MouseEvent e, Circle outputCircle) {
        ...
        Circle speaker = SpeakerWidget.speakerCircle_;
        ...
        VolumeWidget minDistanceWidget = null;
        for (VolumeWidget v : SynthesizeApplication.volumewidgets_){
            Circle volumeReceiver = v.VolumeOutput_;
            ...
            if(distanceToVolume <minDist){
                minDist = distanceToVolume;
                minDistanceWidget = v;
            }
        }
...
//            SpeakerWidget.SpeakerWidgets_.add(this);
            SynthesizeApplication.speaker_.connectInput(this);
            System.out.println("sineWave widget connected to Speaker");
        } else if (minDist < VOLUME_RADIUS_) {
            minDistanceWidget.connectInput(this);
//            minDistanceWidget.AdjustVolume_.connectInput(audioComponent_);
            ...
            SpeakerWidget.SpeakerWidgets_.remove(this);
            SynthesizeApplication.widgets_.remove(this);
//            minDistanceWidget.AdjustVolume_.removeInput(audioComponent_);
        }
    }

    public void connectInput(AudioComponentWidgetBase input) {
        inputWidget_ = input;
        audioComponent_.connectInput(input.getAudioComponent());
    }
